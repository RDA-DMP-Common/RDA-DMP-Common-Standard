...
<ul>
  ...
  <ul>
    ...
    <ul>
      ...
      <li id="dmp_contact_affiliation"><a href="#affiliation_table">affiliation</a></li>
      <ul>
        <li id="affiliation_id_tree"><a href="#affiliation_id">identifier</a></li>
        <li id="affiliation_name_tree"><a href="#affiliation_name">type</a></li>
        <ul>
    ...
    <ul>
      ...
      <li id="dmp_contributor_affiliation"><a href="#affiliation_table">affiliation</a></li>
      <ul>
        <li id="affiliation_id_tree"><a href="#affiliation_id">identifier</a></li>
        <li id="affiliation_name_tree"><a href="#affiliation_name">type</a></li>
        <ul>
