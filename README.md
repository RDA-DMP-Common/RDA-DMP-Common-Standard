...
<h3>Affiliation</h3>
A Contact's or Contributor's institution/organization.
...
<ul>
  ...
  <ul>
    ...
    <ul>
      <li id="contact_affiliation_tree"><a href="#affiliation_table">affiliation</a></li>
      <ul>
        <li id="contact_affiliation_affiliation_id_tree"><a href="#affiliation_affiliation_id_table">affiliation_id</a></li>
        <ul>
          <li id="contact_affiliation_id_identifier_tree"><a href="#affiliation_affiliation_id_identifier">identifier</a></li>
          <li id="contact_affiliation_id_type"><a href="#affiliation_affiliation_id_type_tree">type</a></li>
        </ul>
        <li id="contact_affiliation_name"><a href="#affiliation_affiliation_name_tree">name</a></li>
      </ul>
    ...
    <ul>
      <li id="contributor_affiliation_tree"><a href="#affiliation_table">affiliation</a></li>
      <ul>
        <li id="contributor_affiliation_affiliation_id_tree"><a href="#affiliation_affiliation_id_table">affiliation_id</a></li>
        <ul>
          <li id="contributor_affiliation_id_identifier"><a href="#affiliation_affiliation_id_identifier">identifier</a></li>
          <li id="contributor_affiliation_id_type"><a href="affiliation_#affiliation_id_type_tree">type</a></li>
        </ul>
        <li id="contributor_affiliation_name"><a href="#affiliation_affiliation_name_tree">name</a></li>
      </ul>
...
<tr><td valign="top"><a id="dataset_issued" href="#dataset_issued_tree">issued</a></td><td valign="top">Issued. Encoded using the relevant ISO 8601 Date and Time <a href="https://www.w3.org/TR/NOTE-datetime">compliant string</a></td><td valign="top">Date</td><td valign="top">0..1</td><td valign="top">2019-06-30</td></tr>
...
<tr><td valign="top"><a id="host_storage_type" href="#host_storage_type_tree">storage_type</a></td><td valign="top">The type of storage required</td><td valign="top">String</td><td valign="top">0..1</td><td valign="top">LTO-8 tape</td></tr>
...
<tr><td valign="top"><a id="project_end" href="#project_end_tree">end</a></td><td valign="top">Project end date. Encoded using the relevant ISO 8601 Date and Time <a href="https://www.w3.org/TR/NOTE-datetime">compliant string</a></td><td valign="top">Date</td><td valign="top">0..1</td><td valign="top">2020-03-31</td></tr>
...
<tr><td valign="top"><a id="project_start" href="#project_start_tree">start</a></td><td valign="top">Project start date. Encoded using the relevant ISO 8601 Date and Time <a href="https://www.w3.org/TR/NOTE-datetime">compliant string</a></td><td valign="top">Date</td><td valign="top">0..1</td><td valign="top">2019-04-01</td></tr>
